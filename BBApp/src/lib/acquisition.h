...
public:
    ...
    std::vector<float> calculateWindowFunction(int N, const std::string& type);
};
...
public:
    ...
    const char* what() const throw() { // Thay noexcept bằng throw()
